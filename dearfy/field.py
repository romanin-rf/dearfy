...
@overload
def field(value: None, *, nullable: Literal[True]) -> None: ...
@overload
def field(value: VT, *, nullable: Literal[False]) -> VT: ...
@overload
def field(value: VT, *, wrap: Callable[[VT], WT], nullable: Literal[False]) -> WT: ...
@overload
def field(value: VT, default: DT, wrap: Callable[[VT], WT]) -> WT | DT: ...
@overload
def field(value: VT, default: DT, wrap: Callable[[VT], WT], nullable: Literal[True]) -> WT | DT | None: ...
@overload
def field(value: VT, default: DT, wrap: Callable[[VT], WT], nullable: Literal[False]) -> WT | DT: ...
